...
class AddAssign extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => AddAssignState();
}

class AddAssignState extends State<AddAssign>
    with SingleTickerProviderStateMixin {
  AnimationController controller;
  Animation<double> scaleAnimation;
  ...
  void validateAndSubmit() async {
    ...
    if (validateAndSave()) {
      ...
      try {
        ...
        addAssignFirestore(widget.code, linkData);
        Navigator.pop(context);
  ...
  return Container(
    ...
    child: FlatButton(
      ...
      child: Text(
        text,
        style:
            TextStyle(fontSize: 20, color: Colors.white, fontFamily: 'Lobster'),
      ),
      onPressed: onPressed,
    ),
  );
